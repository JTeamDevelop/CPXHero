...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
CPX.hexPlane.save = function () {
  var realms = {}, mods={};
  for(var x in CPXDB){
    if(CPXDB[x].realm == x) { realms[x]=CPXDB[x].opts; }
  }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
CPX.display.hexPlaneSite = function (map) {
  var sitelist = ["lair","site","ruin","pop"];
  ...
  for (var x in map.cells) {
    ...
    ac.special.forEach(function (S) {
      if(S.visible){
        //don't display populations of less than scale 5
        if(S.type == "pop" && S.scale<5) { return; }

        cdata = {realm:map.realm, map:map._id, cid:ac.id, seed:map.seed};
        dhex = {hex:ac,map:map,data:cdata};

        CPX.display.makeGraphics(makeCircle,CPX.hexPlane.mapClick,map.dispay[S.type],dhex,dchar[S.type]);
      }
    })
  }
